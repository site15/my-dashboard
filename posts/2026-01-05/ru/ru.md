...
![Страница регистрации](images/image21.png)
...
![Письмо с ссылкой на подтверждение e-mail](images/image25.png)
...
![Страница с дашбордами](images/image9.png)
...
![Страница авторизации](images/image32.png)
...
![Страница создания дашборда](images/image14.png)
...
![Страница редактирования дашборда](images/image28.png)
...
![Панель виджетов](images/image17.png)
...
![Страница добавления виджета часов](images/image26.png)

Страница добавления виджета часов

Нажимаем кнопку “Add clock” и добавляем все временные зоны, которые нам нужны.

![Панель с новыми таймзон-часами для виджета часов](images/image20.png)
...
![Кнопка добавления виджета в дашборд](images/image24.png)
...
![Страница редактирования дашборда с виджетом по часам](images/image16.png)
...
![Страница добавления виджета с привычками](images/image2.png)
...
![Страница редактирования дашборда с списком виджетов](images/image2.png)
...
![Панель предпросмотра виджетов](images/image13.png)
...
![Модальное окно виджета часов](images/image11.png)
...
![Модальное окно виджета привычек](images/image18.png)
...
![История увеличения счетчика привычек](images/image7.png)
...
![Страница редактирования дашборда с кнопкой привязки устройства](images/image29.png)

Страница редактирования дашборда с кнопкой привязки устройства

После нажатия откроется страница с QR-кодом.

![Страница с QR-кодом для привязки устройства к дашборду](images/image27.png)
...
![Ссылка на скачивание “Download Mobile App” среди ссылок внизу](images/image5.png)

Ссылка на скачивание “Download Mobile App” среди ссылок внизу

![Ссылка на скачивание “Mobile App” в левой навигационной панели](images/image30.png)
...
![Иконка приложения после установки](images/image8.png)
...
![Пустая страница виджетов](images/image6.png)
...
![Модалка часов](images/image23.png)
...
![Модалка привычек](images/image22.png)
...
![Темная страница с виджетами](images/image19.png)
...
![Горизонтальная темная панель с виджетами](images/image10.png)

Горизонтальная темная панель с виджетами

![Реальная фотография устройства с дашбордом](images/image15.png)
...
![Страница настроек с кнопкой](images/image12.png)
