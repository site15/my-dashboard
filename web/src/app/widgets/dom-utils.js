...
export const domUtils = {
  addClass, addEventListener, appendChild,
  clearChildren, createElement, getAttribute, getElementById, getStyle, removeClass, removeEventListener, setAttribute, setInnerHTML, setStyle, setTextContent
};
