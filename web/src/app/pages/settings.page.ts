...
@Component({
  ...
  template: `
    ...
    <p class="text-xl text-gray-500 mb-8">Configure your dashboard system preferences</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div class="bg-white p-6 rounded-2xl long-shadow">
        ...
        <form class="space-y-4">
          ...
          <div class="flex flex-col">
            <label class="text-gray-700 font-medium mb-2">Notification Preferences</label>
            <div class="space-y-2">
      ...
      <div class="bg-white p-6 rounded-2xl long-shadow">
        ...
        <form class="space-y-4">
          ...
          <div class="flex flex-col">
            <label class="text-gray-700 font-medium mb-2">Data Sync Frequency</label>
            <select class="flat-input">
          ...
          <div class="flex flex-col">
            <label class="text-gray-700 font-medium mb-2">Privacy Settings</label>
            <div class="space-y-2">
    ...
    <div class="bg-white p-6 rounded-2xl long-shadow mt-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h3 class="text-xl font-bold text-gray-800 mb-3">API Configuration</h3>
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <span class="text-gray-600">API Endpoint</span>
              <span class="font-mono text-sm bg-gray-100 px-2 py-1 rounded">/api/v1</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-gray-600">Rate Limiting</span>
              <span class="font-mono text-sm bg-gray-100 px-2 py-1 rounded">1000 req/hr</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-gray-600">Authentication</span>
              <span class="font-mono text-sm bg-gray-100 px-2 py-1 rounded">JWT</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              ...
              <span class="px-2 py-1 rounded-full text-xs bg-green-100 text-green-800">Enabled</span>
            </div>
            <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-between">
              ...
              <span class="font-mono text-sm bg-gray-100 px-2 py-1 rounded">3</span>
            </div>
          </div>
        </div>
      </div>
