...
@Component({
  ...
  template: `
    ...
    <p class="text-xl text-gray-500 mb-8">
      Comprehensive guide to the My Dashboard project
    </p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
      ...
      <div class="bg-white p-6 rounded-2xl long-shadow">
        ...
        <p class="text-gray-600 mb-4">
          My Dashboard is a system for displaying information on old Android
          phones. Users create dashboards through a web application, add
          widgets, and bind phones via QR code.
        </p>
        ...
        <div class="space-y-3">
          <div class="flex items-start">
            <i-lucide
              name="check-circle"
              class="w-5 h-5 text-green-500 mt-0.5 mr-2"
            ></i-lucide>
          ...
          <div class="flex items-start">
            ...
            <span class="text-gray-700"
              >Mobile Application (Ionic + Capacitor)</span
            >
          </div>
          <div class="flex items-start">
            <i-lucide
            ...
            ></i-lucide>
            <span class="text-gray-700"
              >Backend (NestJS + Prisma + PostgreSQL)</span
            >
          </div>
        </div>
      </div>
      ...
      <div class="bg-white p-6 rounded-2xl long-shadow">
        ...
        <div class="space-y-3">
          <div class="flex items-start">
            <i-lucide
              name="smartphone"
              class="w-5 h-5 text-pastel-blue mt-0.5 mr-2"
            ></i-lucide>
            <span class="text-gray-700"
              >Display widgets on old Android phones</span
            >
          </div>
          <div class="flex items-start">
            <i-lucide
            ...
            ></i-lucide>
            <span class="text-gray-700"
              >QR code binding for device connection</span
            >
          </div>
          <div class="flex items-start">
            <i-lucide
    ...
    <div class="bg-white p-6 rounded-2xl long-shadow mb-8">
      ...
      <p class="text-gray-600 mb-4">
        Widgets are the core components of the dashboard system. Currently
        implemented widgets:
      </p>
          ...
          <ol class="space-y-2 text-gray-600">
            ...
            <li class="flex items-start">
              ...
              <span
                ...
                <code class="bg-gray-100 px-1 rounded">npm install</code></span
              >
            </li>
            <li class="flex items-start">
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-600">
            <li class="flex items-start">
              <i-lucide
                name="terminal"
                class="w-4 h-4 text-gray-500 mt-0.5 mr-2"
              ></i-lucide>
              <span
                ><code class="bg-gray-100 px-1 rounded">npm start</code> - Run
                dev server</span
              >
            </li>
            <li class="flex items-start">
              ...
              ></i-lucide>
              <span
                ><code class="bg-gray-100 px-1 rounded">npm run build</code> -
                Build project</span
              >
            </li>
            <li class="flex items-start">
              ...
              ></i-lucide>
              <span
                ><code class="bg-gray-100 px-1 rounded">ionic serve</code> - Run
                mobile app</span
              >
            </li>
          </ul>
