...
@Component({
  ...
  imports: [FormlyBootstrapModule, ReactiveFormsModule, FormlyForm, AsyncPipe, TitleCasePipe, LucideAngularModule],
  template: ` @if (data$ | async; as data) {
    ...
    <p class="text-xl text-gray-500 mb-8">Configure your new widget.</p>
